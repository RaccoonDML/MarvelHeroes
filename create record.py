...
# 原始图片的存储位置
orig_picture = 'D:/Machine_Learning/flower_world-master0/marvel_heroes'

# 生成图片的存储位置
gen_picture = 'D:/Machine_Learning/flower_world-master0/marvel_preprogress'

# 需要的识别类型
classes = {'BlackPanther', 'CaptainAmerican', 'DoctorStrange','IronMan','ScarletWitch','SpiderMan'}
